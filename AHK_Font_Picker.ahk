...
Global GuiHwnd, hEdit1, hEdit2

Gui,+hwndGuiHwnd
Gui,Add,Edit,w500 h200 vMyEdit1 hwndhEdit1,Sample Text
Gui,Add,Edit,w500 h200 vMyEdit2 hwndhEdit2,Sample Text
...
font:
	...
	fontObj := FontSelect(fontObj,GuiHwnd) ; shows the user the font selection dialog
	If (!fontObj)
		return ; to get info from fontObject use ... bold := fontObject["property"]
	
	; method 1 ===========================================
	; fontObj["str"] = an AHK compatible string to set all options
	; ====================================================
	Gui, Font, % fontObj["str"], % fontObj["name"]
	GuiControl,font,MyEdit1
	GuiControl,font,MyEdit2
	
	; method 2 === original method =======================
	; Gui, Font, % "c" fontObj["color"]
	; GuiControl,font,MyEdit1
	; GuiControl,font,MyEdit2
	; SendMessage,0x30,fontObj["hwnd"],1,,ahk_id %hEdit1%
	; SendMessage,0x30,fontObj["hwnd"],1,,ahk_id %hEdit2%
return
